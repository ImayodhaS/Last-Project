...
sound_benar = pygame.mixer.Sound("sounds/benar.wav")
sound_salah = pygame.mixer.Sound("sounds/salah.wav")
sound_gameover = pygame.mixer.Sound("sounds/gameover.mp3")

sound_benar.set_volume(0.5)
sound_salah.set_volume(0.5)
sound_gameover.set_volume(0.4)

pygame.mixer.music.load("sounds/backsound.mp3")
...
sampah_gambar = {
    "organik": load_img("images/organik.png", 2),
    "anorganik": load_img("images/anorganik.png", 1.5),
    "b3": load_img("images/b3.png", 1.5),
}

tong_gambar = {
    "organik": load_img("images/tong_organik.png", 0.4),
    "anorganik": load_img("images/tong_anorganik.png", 0.4),
    "b3": load_img("images/tong_b3.png", 0.4),
}
